  ...
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        ...
        setError("Error al cargar las preguntas semanales.");
      }
    };
    ...
    <Box sx={{ bgcolor: "#FEFEFE", minHeight: "100vh" }}>
      ...
      <Container maxWidth="md" sx={{ mt: 4 }}>
        ...
        <Typography variant="body1" gutterBottom align="center">
          Cada pregunta tiene un valor específico en puntos, así que ¡¡prepárate
          que hoy te toca!! Responde correctamente y acumula puntos para canjear
          por premios increíbles. Recuerda, aquí no solo se trata de responder,
          ¡cada respuesta cuenta y puede acercarte un paso más a ese premio que
          tanto deseas!
        </Typography>
        ...
        <Box sx={{ my: 4, p: 3, bgcolor: "#f9f9f9", borderRadius: "8px" }}>
          ...
          <Typography variant="body2" gutterBottom>
            - La plataforma solo permite <strong>2 respuestas</strong> en total
            para cada pregunta. Una vez que 2 usuarios hayan enviado sus
        ...
        <Dialog open={openDialog} onClose={handleCloseDialog}>
          ...
          <DialogContent>
            <DialogContentText>{dialogError}</DialogContentText>
          </DialogContent>
          <DialogActions>
